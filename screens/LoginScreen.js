...
import { StyleSheet, View, Button, Text, SafeAreaView, StatusBar, Platform, Dimensions, Image } from "react-native";
  ...
  signInWithGoogleAsync = async () => {
    try {
      const result = await Google.logInAsync({
        ...
        iosClientId:
          "102344845173-oqka83r73o5986ngtghs7loe6inukmqm.apps.googleusercontent.com",
